...
def combine_files(directory_path, output_file, exclude_folders=None, include_extensions=None, exclude_extensions=None):
    """
...
def main():
    parser = argparse.ArgumentParser(description='Combine multiple files into a single text file.')
    ...
    parser.add_argument('--include-extensions', nargs='+', help='File extensions to include (e.g., .txt .py)')
